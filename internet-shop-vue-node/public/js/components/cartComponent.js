Vue.component('cart', {
    ...
    methods: {
        ...
        removeAll(str) {
            this.$parent.deleteJson(`/api/cart`, { quantity: 'all' })
                .then(data => {
                    if (data.rezult === 1) {
                        this.cartItems = [];
                    }
    ...
    template: `<div class="cart_wrap">
                    ...
                    <div class="cart_left">
                        ...
                        <div class="cart_left_btn_box" @remove-all="removeAll">
                                <button class="cart_left_btn clear" @click="$emit('remove-all', 'all')">clear shopping cart</button>
